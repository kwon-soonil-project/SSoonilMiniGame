...
<template>
  <div class="liar-game" data-region="liar-game">
    ...
    <DiscussionPanel v-else-if="publicState.phase === 'DISCUSSING'" :disabled="discussionDisabled" :proposal-active="publicState.submittedPlayerIds.length > 0" @propose="send('DISCUSSION_END_PROPOSE')" @approve="send('DISCUSSION_END_VOTE', { agree: true })" />
